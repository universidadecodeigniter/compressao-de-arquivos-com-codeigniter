...
<html lang="pt_BR">
  <head>
    ...
    <meta name="description" content="Tutorial ensinando a trabalhar com compressão de arquivo no CodeIgniter">
    <meta name="author" content="Universidade CodeIgniter">
    <link rel="icon" href="<?=base_url('assets/images/unici/favicon.png')?>">

    <title>Compressão de arquivos com CodeIgniter</title>
